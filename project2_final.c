...
All prerequisites have been implemented. Rercursive printing also.
...
typedef struct
{
    ...
    double longitude;   //double for more percise
}location;
...
typedef struct incList
{
    ...
    int node_counter;			// XRISIMO GIA DEBUG
...
int main()
{
    ...
    while (!userExit)
    {
        ...
        printf("\n ---------------------------------");
        printf("\n Enter your command (type `exit` to finish or `help` for help)\n$>");
